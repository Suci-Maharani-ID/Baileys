...
const generateWAMessageContent = async (message, options) => {
    ...
    if ('text' in message) {
        ...
        const _m = await (0, exports.prepareWAMessageMedia)(message, options);
...
const patchMessageForMdIfRequired = (message) => {
    var _a;
    if ((message === null || message === void 0 ? void 0 : message.buttonsMessage) ||
        (message === null || message === void 0 ? void 0 : message.templateMessage) ||
        (message === null || message === void 0 ? void 0 : message.listMessage) ||
        ((_a = message === null || message === void 0 ? void 0 : message.interactiveMessage) === null || _a === void 0 ? void 0 : _a.nativeFlowMessage)) {
        message = {
