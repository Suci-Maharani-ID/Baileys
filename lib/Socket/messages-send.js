...
const makeMessagesSocket = (config) => {
    ...
    const userDevicesCache = config.userDevicesCache || (0, Utils_1.createSimpleCache)(Defaults_1.DEFAULT_CACHE_TTLS.USER_DEVICES);
    let mediaConn;
    ...
    const relayMessage = async (jid, message, { messageId: msgId, participant, additionalAttributes, additionalNodes, useUserDevicesCache, useCachedGroupMetadata, statusJidList }) => {
        ...
        await authState.keys.transaction(async () => {
            ...
            if (!isNewsletter && buttonType) {
                ...
                const nodesToAdd = additionalNodes !== null && additionalNodes !== void 0 ? additionalNodes : [];
                const useAdditional = (0, WABinary_1.getBinaryFilteredButtons)(nodesToAdd);
                const nodeToPush = useAdditional ? additionalNodes : buttonsNode;
                if (Array.isArray(nodeToPush)) {
                    stanza.content.push(...nodeToPush);
                }
                else if (nodeToPush) {
                    stanza.content.push(nodeToPush);
                }
    ...
    const getButtonArgs = (message) => {
        var _a, _b, _c, _d;
        if (((_a = message.interactiveMessage) === null || _a === void 0 ? void 0 : _a.nativeFlowMessage) && ((_c = (_b = message.interactiveMessage.nativeFlowMessage) === null || _b === void 0 ? void 0 : _b.buttons) === null || _c === void 0 ? void 0 : _c.length) > 0 && message.interactiveMessage.nativeFlowMessage.buttons[0].name === 'review_and_pay') {
            return {
                tag: 'biz',
                attrs: {
        ...
        else if (((_d = message.interactiveMessage) === null || _d === void 0 ? void 0 : _d.nativeFlowMessage) || message.buttonsMessage) {
            return {
                tag: 'biz',
                attrs: {},
                content: [{
