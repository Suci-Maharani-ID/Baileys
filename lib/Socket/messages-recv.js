...
const makeMessagesRecvSocket = (config) => {
    ...
    const msgRetryCache = config.msgRetryCounterCache || (0, Utils_1.createSimpleCache)(Defaults_1.DEFAULT_CACHE_TTLS.MSG_RETRY);
    const callOfferCache = config.callOfferCache || (0, Utils_1.createSimpleCache)(Defaults_1.DEFAULT_CACHE_TTLS.CALL_OFFER);
    const placeholderResendCache = config.placeholderResendCache || (0, Utils_1.createSimpleCache)(Defaults_1.DEFAULT_CACHE_TTLS.MSG_RETRY);
